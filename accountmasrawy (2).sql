...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 27, 2022 at 11:26 PM
...
INSERT INTO `masary_pay` (`id_masary_pay`, `date_masary_pay`, `id_utility_masary`, `price_masary_pay`, `id_client`, `discount_of_balance`, `amount_masary_pay`, `id_pos`, `balance`, `phone`) VALUES
(17, '2022-06-27', 39, 2.00, 1, 20.00, 22.00, 1, 10747.9, NULL),
(18, '2022-06-27', 42, 1.00, 1, 25.00, 26.00, 1, 10722.9, NULL),
(20, '2022-06-27', NULL, 10.00, 1, 14.30, 15.00, 1, 10695.1, '01127333021'),
(21, '2022-06-27', 40, 1.00, 1, 13.50, 15.00, 1, 10927.2, '13.5'),
(22, '2022-06-27', 72, 50.00, 1, 71.50, 75.00, 1, 10855.7, '01127333021'),
(23, '2022-06-27', 72, 80.00, 1, 114.40, 120.00, 1, 10741.300000000001, '0112543658'),
(24, '2022-06-27', 72, 35.00, 1, 50.05, 52.50, 1, 10691.25, '01237525212');
...
--
ALTER TABLE `casher`
  MODIFY `id_casher` bigint(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
...
--
ALTER TABLE `masary_pay`
  MODIFY `id_masary_pay` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
