...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 05, 2022 at 01:34 AM
...
('2022-07-05', 3881.5, 0, 0, '00:33:34');
...
(2, '010-32064920', 'اشرف محمد احمد محمد', '28710022800194', '89200-22022-81925-1975', 5000.00, 344);
...
--
ALTER TABLE `casher`
  MODIFY `id_casher` bigint(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=193;
...
--
ALTER TABLE `masary_pay`
  MODIFY `id_masary_pay` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=151;
