...
--
-- Host: 127.0.0.1
-- Generation Time: May 31, 2022 at 02:15 PM
...
(41, '2022-05-30', 70250.00, NULL, 'دفعة من حساب  مصطفي يوسف');
...
(21, '2022-05-30', NULL, 70250.00, 3, NULL, 10, 'دفعة من حساب  مصطفي يوسف', 1);
...
(1, 'مورد نقدي', NULL, NULL, NULL, NULL),
(2, 'ممدوح الزين', '0112725232', 'القاهرة', '25611182800548', 50000.00);
...
--
ALTER TABLE `casher`
  MODIFY `id_casher` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT for table `clientaccount`
--
ALTER TABLE `clientaccount`
  MODIFY `id_ClientAccount` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `purchaseinvoice`
--
ALTER TABLE `purchaseinvoice`
  MODIFY `id_purchaseInvoice` int(11) NOT NULL AUTO_INCREMENT;
