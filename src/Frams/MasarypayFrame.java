 ...
 * @author mosta
 */
public class MasarypayFrame extends javax.swing.JFrame {
...
//            txtPhone.getActionMap().put("commit", autocomplete.new CommitAction());      
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MasarypayFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MasarypayFrame().setVisible(true);
            }
        });
    }
