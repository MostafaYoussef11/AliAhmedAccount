 ...
 * @author mosta
 */
public class BeepayFrame extends javax.swing.JFrame {
    ...
    public BeepayFrame() {
        ...
        font = Tools.font(24f);
        title.setFont(font);
        Bee_util = new masary_Utilites(2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BeepayFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BeepayFrame().setVisible(true);
            }
        });
    }
