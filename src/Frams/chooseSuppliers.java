 ...
 * @author mosta
 */
public class chooseSuppliers extends javax.swing.JFrame {
    ...
    public chooseSuppliers() {
        initComponents();
        setOpacity(0.9f);
        suppliers.FillComboName(jComboBox1);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(chooseSuppliers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new chooseSuppliers().setVisible(true);
            }
        });
    }
