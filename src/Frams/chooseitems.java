 ...
 * @author mosta
 */
public class chooseitems extends javax.swing.JFrame {
    ...
    public chooseitems() {
        initComponents();
        setOpacity(0.9f);
        item.fillComboNameItems(jComboBox1);
    }
...
//        para.put("id_items", id_items_str);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(chooseitems.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new chooseitems().setVisible(true);
            }
        });
    }
