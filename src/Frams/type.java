...
public class type extends javax.swing.JFrame {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if(name.length() == 0){
            Tools.showErrorMsg("البيانات غير مكتملة!!");
        }else{
          String sql = "INSERT INTO type VALUES ("+id+",'"+name+"');";
          boolean isSave = ConnectDB.ExucuteAnyQuery(sql);
          if(isSave){
              Tools.showInfoMsg("تم الحفظ بنجاح" , "Save");
              setNew();
          }else{
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        id = txtId.getText();
        name = txtName.getText();
        String sql = "UPDATE type SET name_type ='"+name+"' WHERE id_type="+id+";";
        boolean isUpdate = ConnectDB.ExucuteAnyQuery(sql);
        if(isUpdate){
            Tools.showInfoMsg("تم تحديث بنجاح" , "UpDate");
            setNew();
        }
        else{
            Tools.showErrorMsg("خطأ");
    ...
    private void btnDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelActionPerformed
        ...
        boolean isDel = ConnectDB.ExucuteAnyQuery(sql);
        if(isDel){
            Tools.showInfoMsg("تم تحديث البيانات" , "Delete");
        }else{
            Tools.showErrorMsg("خطأ");
        }
    ...
    private void setNew(){
        id = ConnectDB.LastId("type", "id_type");
        txtId.setText(id);
        txtName.setEnabled(true);
        txtName.setText("");
        String sql = "select name_type , id_type from type";
