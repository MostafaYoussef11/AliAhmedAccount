 ...
 * @author mosta
 */
public class typeExpenMillFram extends javax.swing.JFrame {

    /**
     * Creates new form typeExpensChefrFrame
     */
    public typeExpenMillFram() {
        initComponents();
        SetNew();
    }
    ...
    private void btsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btsaveActionPerformed
        MillClass ch = new MillClass();
        String name = txtName.getText();
        boolean isSave = ch.SaveTypeEpenesMill(name);
        if(isSave){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(typeExpenMillFram.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new typeExpenMillFram().setVisible(true);
            }
        });
    }
    private void SetNew(){
        txtid.setText(ConnectDB.LastId("typeexpensmill", "id_typeexpensmill"));
        txtName.setText("");
