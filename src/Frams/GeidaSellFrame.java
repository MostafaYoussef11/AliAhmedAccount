 ...
 * @author mosta
 */
public class GeidaSellFrame extends javax.swing.JFrame {
   ...
   // PosSell masary;
    public GeidaSellFrame(int type_supplier) {
        initComponents();
...
//        });
    ...
    private void initComponents() {
        ...
        txt_title.setText("شحن ماكينة Geidea");
        ...
        txt_note.setText("شحن ماكينة Geidea");
    ...
    private void btsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btsaveActionPerformed
        try{                                       
            ...
            switch(name_recharge_type){
                case "نقدي":
                    geidea.SetDataAndgeter(value, amount, name_recharge_type, to_account, null);
                    isSave = geidea.SaveCash();
                    break;
                case "مندوب":
                    geidea.SetDataAndgeter(value, amount, name_recharge_type, to_account, null);
                    isSave = geidea.SaveAccountSupplier();
                    break;
                default:
                    geidea.setDataUseSave(value, amount, to_account, id_pos );
                    isSave = geidea.SaveVFCash(); // method add to VF-Cash
                    break;
            }
            if(isSave){
            ...
            Logger.getLogger(GeidaSellFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void newSell(){
        ...
        geidea.fillComboRechargeType(comb_recharge_type);
        comb_recharge_type.setSelectedIndex(1);
        geidea.fillTable(jTable1);
        txt_amount.setText("0.00");
        txt_value.setText("0.00");
        suppliers.FillComboAllNameSupplierByType(comb_to_account);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GeidaSellFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GeidaSellFrame(0).setVisible(true);
            }
        });
    }
