 ...
 * @author mosta
 */
public class AmanpayFrame extends javax.swing.JFrame {
    ...
    private void newMasaray(){
        ...
        String balance = String.valueOf(aman.getfirstBalance());
    ...
    private void btsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btsaveActionPerformed
        ...
        aman.setPrice_masary_pay(price_masary_pay);
        aman.setId_client(id_client);
    ...
    private void combClientItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_combClientItemStateChanged
        // TODO add your handling code here:
        aman.viewPhoneNumberClient(txtPhone, combClient);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AmanpayFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AmanpayFrame().setVisible(true);
            }
        });
    }
