 ...
 * @author mosta
 */
public class GiedeapayFrame extends javax.swing.JFrame {
    ...
    private void newMasaray(){
        ...
        String balance = String.valueOf(giedea.getfirstBalance());
        ...
        giedea.fillTable(jTable1);
        double price = Bee_util.getPriceByNote(note);
    ...
    private void btsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btsaveActionPerformed
        ...
        try{
            ...
            Logger.getLogger(GiedeapayFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
        giedea.setAmount_masary_pay(amount_masary_pay);
        giedea.setDiscount_of_balance(discount_of_balance);
        giedea.setPrice_masary_pay(price_masary_pay);
        giedea.setId_client(id_client);
        if(txtPhone.isEnabled()){
            giedea.setPhone(txtPhone.getText());
            giedea.setUtility_masary(txtPhone.getText());
            giedea.setId_utility_masary(not_utilitiy);
            giedea.setIs_requer_phone_num(true);
        }
        else{
            giedea.setPhone(null);
            giedea.setId_utility_masary(not_utilitiy);
            giedea.setUtility_masary(not_utilitiy);
            giedea.setIs_requer_phone_num(false);
        }
        if(id_client == 1){
            isSave = giedea.SaveCasher();
        }else{
            isSave = giedea.SaveClients();
        }
    ...
    private void combClientItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_combClientItemStateChanged
        // TODO add your handling code here:
        giedea.viewPhoneNumberClient(txtPhone, combClient);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GiedeapayFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GiedeapayFrame().setVisible(true);
            }
        });
    }
