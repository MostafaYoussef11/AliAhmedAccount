 ...
 * @author mosta
 */
public class FawrySellFrame extends javax.swing.JFrame {
   ...
   // PosSell masary;
    ...
    private void initComponents() {
        ...
        txt_title.setText("شحن ماكينة Fawry");
    ...
    private void btsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btsaveActionPerformed
        try{                                       
            ...
            switch(name_recharge_type){
                case "نقدي":
                    fawry.SetDataAndgeter(value, amount, name_recharge_type, to_account, null);
                    isSave = fawry.SaveCash();
                    break;
                case "مندوب":
                    fawry.SetDataAndgeter(value, amount, name_recharge_type, to_account, null);
            ...
            Logger.getLogger(FawrySellFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FawrySellFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FawrySellFrame(0).setVisible(true);
            }
        });
    }
