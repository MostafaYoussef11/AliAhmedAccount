 ...
 * @author mosta
 */
public class BankTransactionFrame extends javax.swing.JFrame {
    ...
    private void btsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btsaveActionPerformed
        ...
        boolean isSave = bank.SaveTransactionBanck(numberAccount, amount, particular, bankAccounts.typeTransaction.debit);
        if(isSave){
            Tools.showInfoMsg("تم الايداع", "حفظ");
            setNew();
        }
        else{
    ...
    private void comBankItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_comBankItemStateChanged
        ...
        particular = "ايداع نقدي في حساب " + comBank.getSelectedItem().toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BankTransactionFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BankTransactionFrame().setVisible(true);
            }
        });
    }
