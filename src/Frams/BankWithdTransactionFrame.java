 ...
 * @author mosta
 */
public class BankWithdTransactionFrame extends javax.swing.JFrame {

    /**
     * Creates new form BankTransactionFrame
     */
    private bankAccounts bank;
    private Dimension dim;
    private String particular;
    private String StAmount = "";
    public BankWithdTransactionFrame() {
        initComponents();
        dim = new Dimension(850, 660);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("سحب بنكي");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(10, 11, 820, 63);
        ...
        jLabel3.setText("الحساب");
        jLabel3.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        comBank.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        comBank.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                comBankItemStateChanged(evt);
            }
        });
        ...
        jLabel2.setText("رصيد الحساب");
        jLabel2.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        txt_Balance.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        txt_particular.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        txt_particular.setHorizontalAlignment(javax.swing.JTextField.CENTER);
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(txt_amount, javax.swing.GroupLayout.DEFAULT_SIZE, 286, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel4, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(comBank, javax.swing.GroupLayout.PREFERRED_SIZE, 296, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(txt_particular)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel5, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txt_Balance, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(comBank, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jLabel2, javax.swing.GroupLayout.DEFAULT_SIZE, 33, Short.MAX_VALUE)
                    .addComponent(txt_Balance, javax.swing.GroupLayout.DEFAULT_SIZE, 33, Short.MAX_VALUE)
        ...
        jPanel1.setBounds(10, 80, 820, 98);
        ...
        jScrollPane1.setBounds(10, 184, 820, 360);
        ...
        btPanel.setBounds(10, 555, 820, 61);
    ...
    private void btsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btsaveActionPerformed
        ...
        String numberAccount = comBank.getSelectedItem().toString();
        boolean isSave = bank.SaveTransactionBanck(numberAccount, amount, particular, bankAccounts.typeTransaction.credit);
        if(isSave){
            Tools.showInfoMsg("تم السحب", "حفظ");
            setNew();
        }
        else{
    ...
    private void comBankItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_comBankItemStateChanged
        // TODO add your handling code here:
        String numberAndName = comBank.getSelectedItem().toString();
        String idBank = bank.idBank(numberAndName);
        double balance = bank.getNowBalanceByID(idBank);
        txt_Balance.setText(balance+"");
        particular = "سحب نقدي من حساب " + comBank.getSelectedItem().toString();
        txt_particular.setText(particular);
    }//GEN-LAST:event_comBankItemStateChanged

    private void txt_amountKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_amountKeyReleased
        // TODO add your handling code here:
        String note =  "  _ "+" مبلغ " ;
        StAmount = txt_amount.getText();
        //particular = particular + ;
        txt_particular.setText(particular + note + StAmount);
        
    }//GEN-LAST:event_txt_amountKeyReleased
    private void setNew(){
        bank.FillComboNumberBank(comBank);
        txt_amount.setText("0.00");
        txt_particular.setText("");
        comBank.addItem("أختر الحساب");
        comBank.setSelectedItem("أختر الحساب");
        Tools.disableButOpen(btPanel);
        String sql = "SELECT `balance`,`credit`,`debit`,`particulars`,`date_transaction` FROM `banktransaction`";
        String[]  columnName = { "الرصيد", "دائن", "مدين", "البيان", "التاريخ"};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BankWithdTransactionFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BankWithdTransactionFrame().setVisible(true);
            }
        });
    }
