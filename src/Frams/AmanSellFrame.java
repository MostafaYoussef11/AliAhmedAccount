 ...
 * @author mosta
 */
public class AmanSellFrame extends javax.swing.JFrame {
...
//        });
    ...
    private void initComponents() {
        ...
        txt_title.setText("شحن ماكينة Aman");
    ...
    private void btsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btsaveActionPerformed
        try{                                       
            ...
            Logger.getLogger(AmanSellFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AmanSellFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AmanSellFrame(0).setVisible(true);
            }
        });
    }
