 ...
 * @author mosta
 */
public class OpaySellFrame extends javax.swing.JFrame {
   ...
   // PosSell masary;
    public OpaySellFrame(int type_supplier) {
        initComponents();
        setSize(dim);
    ...
    private void initComponents() {
        ...
        txt_title.setText("شحن ماكينة OPay");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OpaySellFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OpaySellFrame(0).setVisible(true);
            }
        });
    }
