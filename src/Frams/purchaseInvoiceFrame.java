 ...
 * @author mosta
 */
public class purchaseInvoiceFrame extends javax.swing.JFrame {
...
//        }
    ...
    private void btsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btsaveActionPerformed
        ...
        if(size == 0){
            ...
            invoice.setRemainingAmount(Double.parseDouble(txtRemainingAmount.getText()));
    ...
    private void comboPaymentMethodItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_comboPaymentMethodItemStateChanged
       ...
       String id_salesInvoic = txtId_Invoice.getText() ;
        switch(payMethod){
            ...
            case deferred:
                txtAmountCashing.setEnabled(false);
                suppliers.setId_supplier_type(1);
                suppliers.FillComboAllNameSupplierByType(comboName);
...
//        }
    ...
    private void calcSumPrice(){
        ...
        String discoundSt = txtDiscondItem.getText();
        double priceUnit = Double.valueOf(price);
        double count = Double.valueOf(countStr);
        double discound = Double.valueOf(discoundSt);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(purchaseInvoiceFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new purchaseInvoiceFrame().setVisible(true);
            }
        });
    }
