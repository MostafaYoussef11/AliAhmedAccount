...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 26, 2022 at 06:56 PM
...
INSERT INTO `utility_masary` (`id_utility_masary`, `name_utility_masary`, `note_utility`, `cost_by_perse`) VALUES
(8, 'كروت اتصالات', 'كرت اتصالات 10', 0.00),
(9, 'كروت اتصالات', 'كرت اتصالات 15', 0.00),
(10, 'كروت اتصالات', 'كرت اتصالات 25', 0.00),
(11, 'كروت اتصالات', 'كرت اتصالات 50', 0.00),
(12, 'كروت اتصالات', 'كرت اتصالات 100', 0.00),
(13, 'كروت اورنج', 'كرت اورنج 10', 0.00),
(14, 'كروت اورنج', 'كرت اورنج 15', 0.00),
(15, 'كروت اورنج', 'كرت اورنج 25', 0.00),
(16, 'كروت اورنج', 'كرت اورنج 50', 0.00),
(17, 'كروت اورنج', 'كرت اورنج 100', 5.00),
(19, 'شحن اتصالات', 'شحن اتصالات', 0.43);
...
--
ALTER TABLE `casher`
  MODIFY `id_casher` bigint(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
...
--
ALTER TABLE `utility_masary`
  MODIFY `id_utility_masary` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
